{if $login->isLogged()}
    ...
    {if $login->isAdmin()}
			...
			<li class="mnu_last{if $PAGENAME eq "vehicles_list.php" or $PAGENAME eq "vehicles_edit.php"} selected{/if}"><a href="{$galette_base_path}{$galette_galette_auto_path}vehicles_list.php">{_T string="Cars list"}</a></li>
    {/if}
